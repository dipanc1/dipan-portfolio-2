import { faAngular, faGitAlt, faJava, faJsSquare, faMicrosoft, faNodeJs, faReact } from '@fortawesome/free-brands-svg-icons';
            ...
            <div className='container about-page'>
                ...
                <div className="stage-cube-cont">
                    <div className="cubespinner">
                        ...
                        {/* <div className="face3">
                        <FontAwesomeIcon icon={faDatabase} color="grey" />
                    </div> */}
                        {/* <div className="face4">
